...
const Contact: React.FC = () => {
  const contactMethods = [
    {
      title: 'Development',
      email: 'jmbornaisdeveloper@gmail.com',
      description: 'For software development inquiries, collaborations, and tech discussions.',
      icon: (
    ...
    },
    {
      ...
      description: 'For bookings, weddings, performances, and musical collaborations.',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/justinbornais',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/justin-bornais/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Whether you want to discuss a project, collaborate on music, or just say hello, 
          ...
          <div className="flex justify-center gap-6">
            {socialLinks.map((social) => (
              <a
                ...
                className="flex items-center justify-center w-14 h-14 rounded-lg bg-neutral-700 text-gray-400 hover:bg-neutral-600 hover:text-white transition-all hover:scale-110"
